...
HL 2020-5-15
revise from: HL_FP_ParseSti.m
to read camera exposure trace and get the ts for camera frames and parse
trial structure

%}
%%
function [CtxSti, ThresholdValue]= HL_FP_ParseCam(CtxSti_ch, sr, ThresholdValue, stimulus_length)
...
% camera exposure is going down from 1 to 0 digital input
